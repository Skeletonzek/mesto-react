...
<div className="page">
  <PopupWithForm name="profile" title="Редактировать профиль" submit="Сохранить" isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>    
    <input className="popup__text popup-profile__text" id="name-input" type="text" name="name" minLength="2" maxLength="40" required />
    <span className="popup__error" id="name-input-error"></span>
    <input className="popup__text popup-profile__text" id="status-input" type="text" name="about" minLength="2" maxLength="200" required />
